/* ═══════════════════════════════════════════════════════════
   ...
   FIXE de ± SPREAD/2 appliquée à la VALEUR D'ENTREPRISE, à laquelle
   on ajoute ensuite la trésorerie nette (soit 10 % de large sur la VE).
...
(() => {
  ...
  function computeValue() {
    ...
    return {
      ...
      net,
      equity,
      low: ev * (1 - SPREAD / 2) + net,
      high: ev * (1 + SPREAD / 2) + net,
    };
  }
  ...
  function bridgeHtml(value) {
    ...
    let rows = `
      <div class="est-bridge-row">
        <span class="est-bridge-lbl">Valeur d'entreprise</span>
    ...
    rows += `
      <div class="est-bridge-row est-bridge-total">
        <span class="est-bridge-lbl">Valeur de vos titres</span>
